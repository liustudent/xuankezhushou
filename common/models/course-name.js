...
module.exports = function(Coursename) {
    ...
    Coursename.disableRemoteMethodByName('prototype.__destroyById__crawl_courses'); //disables DELETE /course_names/{id}/crawl_courses/{fk}
    ...
    Coursename.disableRemoteMethodByName('prototype.__updateById__static_courses'); //disables PUT /course_names/{id}/static_courses/{fk}
    Coursename.disableRemoteMethodByName('prototype.__destroyById__static_courses'); //disables DELETE /course_names/{id}/static_courses/{fk}
